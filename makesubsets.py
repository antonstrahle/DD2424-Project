...
# This code creates folders Subsets with subsets on your computer. It needs only to be
...
# pics per species in a subsets for different subset sizes:
small = 5
medium = 50
full = n_species    
...
def move_imgs(selected_species, subset):
    for species in selected_species:
        ...
        shutil.copytree("../Data/valid" +"/"+species,"../Subsets/"+subset+"Small"+"/val/" +species)
...
CB=["ALEXANDRINE PARAKEET","AMERICAN GOLDFINCH", "AMERICAN REDSTART","ANNAS HUMMINGBIRD",
    ...
    "CHARA DE COLLAR", "CINNAMON TEAL", "COCK OF THE  ROCK", "COUCHS KINGBIRD","CROWNED PIGEON",
...
CD=["AMERICAN BITTERN","AMERICAN KESTREL", "AMERICAN PIPIT", "BARN OWL", "BARN SWALLOW", "BAR-TAILED GODWIT",
    "BLACK FRANCOLIN", "BLACK-CAPPED CHICKADEE", "BLACK-THROATED SPARROW", "BLUE GROUSE",
...
def move_subset(subset, spec_list):
    ...
    for species in spec_list:
        ...
        shutil.copytree("../Data/valid" +"/"+species,"../Subsets/"+subset+"Full"+"/val/" +species)
